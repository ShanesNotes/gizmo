...
- An adversarial verification workflow (9 agents + completeness critic)
  independently re-derived the vectors, validated the NARRATIVE.md fiction quotes
  and all four simulation.ts citations, and re-ran the suite green.
...
## Notes
- Fiction: code `xp` = **Sparks** (NARRATIVE §4), the collected currency — NOT
  the **Spark of Humanity** survival meter (player health), which is 0007.
