...
| HZ-074 | SPECIAL/CAST live damage wiring | Codex | feel | in-progress | 071 |
| HZ-075 | THE CUSTODIAN first boss (design/boss-custodian.md) | Codex | boss | ready-for-agent | 074 |
...
| HZ-079 | extract CombatResolvers module from run_orchestrator (god-module split) | Codex | arch | ready-for-agent | 074 |
