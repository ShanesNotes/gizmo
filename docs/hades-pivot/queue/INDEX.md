...
| HZ-096 | asset retro-promotion: 4 demo models through the lab (briefs, cleanup, wrappers) | Codex | assets | ready-for-agent | plan-P2 |
| HZ-097 | gouache render target per design-system shader-matrix (G12) | Codex | look | ready-for-agent | plan-P3 |
