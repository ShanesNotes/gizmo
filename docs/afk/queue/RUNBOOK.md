...
```
You are an AFK coding agent for Gizmo (Godot 4.7 3D rogue-lite), repo C:/Users/Shane/gizmo,
...
## Dispatcher loop (human or orchestrator, once per session wave)
...
## Wave plan (expected)
- Wave 1: GZ-001 [Opus] + GZ-010, GZ-014, GZ-017, GZ-018 [cheap] + GZ-030/031 in their labs.
- Wave 2: GZ-002, GZ-011 (then 012), GZ-013 (after 005 later — skip), GZ-016 after 002.
- Waves 3–6: sim lane marches 003→009 while cluster-B tickets land between sim merges
